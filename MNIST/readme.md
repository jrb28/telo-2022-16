...
Output from this code includes the following files in the designated output folder where _i_ is the MNIST index:
...
- xxxxx  within the list generated from `../input/randMNIST.json`
